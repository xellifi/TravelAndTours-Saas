...
const defaultCardData: BentoCardProps[] = [
  {
    ...
    description: 'We reply to booking requests within a few hours.',
    label: 'Speed',
  },
  {
    color: '#120F17',
    title: 'Safe Payments',
    description: 'Pay via GCash, Maya, or bank transfer — your choice.',
    label: 'Trust',
  },
  {
    color: '#120F17',
    title: 'Personal Support',
    description: 'Talk to a real human, before, during, and after your trip.',
    label: 'Care',
  },
  {
    color: '#120F17',
    title: 'Flexible Plans',
    description: 'Reschedule or adjust your booking with ease.',
    label: 'Freedom',
  },
  {
    color: '#120F17',
    title: 'Curated Experiences',
    description: 'Hand-picked destinations and activities our team loves.',
    label: 'Quality',
  },
  {
    color: '#120F17',
    title: 'Trusted Service',
    description: 'Hundreds of happy travelers booked with confidence.',
    label: 'Proof',
  },
];
