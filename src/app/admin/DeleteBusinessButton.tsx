...
import { adminDeleteBusinessAction, type BusinessDeleteState } from './actions';
...
export default function DeleteBusinessButton({
  ...
  const [state, formAction] = useActionState<BusinessDeleteState, FormData>(
  ...
  const matches = confirmText.trim().toLowerCase() === businessSlug.toLowerCase();
