      ...
      <div className="flex items-end justify-between mb-8 flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Every landing page on the platform. Clone any of them to a new
            owner in one click.
          </p>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-8 py-4 text-xs font-bold text-gray-500 uppercase tracking-wide">
                Business
              </th>
              <th className="px-8 py-4 text-xs font-bold text-gray-500 uppercase tracking-wide">
                Template
              ...
              <th className="px-8 py-4 text-xs font-bold text-gray-500 uppercase tracking-wide text-right">
                Actions
              </th>
            </tr>
          </thead>
                ...
                <td className="px-8 py-5 text-sm">
                  {biz.users?.email ? (
                    <div>
                      ...
                      <p className="text-xs text-gray-500">{biz.users.email}</p>
                    </div>
                  ) : (
